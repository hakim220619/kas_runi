...
Route::middleware(['auth'])->group(function () {
    ...
    //Kas
    Route::get('kas', [KasController::class, 'view'])->name('kas');
    Route::get('addKas', [KasController::class, 'addKas'])->name('kas.addKas');
    Route::post('kas/addProses', [KasController::class, 'addProses'])->name('kas.addProses');
    Route::post('kas/editProses', [KasController::class, 'editProses'])->name('kas.editProses');
    Route::get('kas/delete/{id}', [KasController::class, 'delete'])->name('kas.delete');
});
